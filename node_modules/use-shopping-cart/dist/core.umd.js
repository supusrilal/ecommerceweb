(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@reduxjs/toolkit'), require('redux-persist'), require('uuid'), require('@stripe/stripe-js')) :
  typeof define === 'function' && define.amd ? define(['exports', '@reduxjs/toolkit', 'redux-persist', 'uuid', '@stripe/stripe-js'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.UseShoppingCartCore = {}, global.RTK, global.ReduxPersist, global.uuid));
})(this, (function (exports, toolkit, reduxPersist, uuid) { 'use strict';
