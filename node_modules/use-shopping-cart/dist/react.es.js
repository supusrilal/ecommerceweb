...
const _jsxFileName = "/Users/nickdejesus/Code/hooks/use-shopping-cart/use-shopping-cart/react/index.js"; function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }const CartContext = React.createContext(initialState);
...
function CartProvider({ loading = null, children, ...props }) {
  ...
  if (_optionalChain([props, 'optionalAccess', _ => _.shouldPersist]) || props.shouldPersist === undefined) {
    return (
      React.createElement(Provider, { context: CartContext, store: store, __self: this, __source: {fileName: _jsxFileName, lineNumber: 24}}
    ...
    return (
      React.createElement(Provider, { context: CartContext, store: store, __self: this, __source: {fileName: _jsxFileName, lineNumber: 36}}
        , children
      )
    )
  }
...
function DebugCart(props) {
  ...
  const cartPropertyRows = Object.entries(cart)
    ...
    .map(([key, value]) => (
      React.createElement('tr', { key: key, __self: this, __source: {fileName: _jsxFileName, lineNumber: 64}}
        , React.createElement('td', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 65}}, key)
        , React.createElement('td', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 66}}
          , typeof value === 'object' ? (
            React.createElement('button', { onClick: () => console.log(value), __self: this, __source: {fileName: _jsxFileName, lineNumber: 68}}, "Log value" )
          ) : (
  ...
  return (
    React.createElement('div', {
      ...
      , React.createElement('table', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 91}}
        , React.createElement('thead', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 92}}
          , React.createElement('tr', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 93}}
            , React.createElement('th', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 94}}, "Key")
            , React.createElement('th', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 95}}, "Value")
          )
        )
        , React.createElement('tbody', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 98}}, cartPropertyRows)
      )
    )
  )
}

export { CartContext, CartProvider, DebugCart, actions, filterCart, formatCurrencyString, useDispatch, useSelector, useShoppingCart };
