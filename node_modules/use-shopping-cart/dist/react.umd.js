(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@reduxjs/toolkit'), require('uuid'), require('redux-persist'), require('@stripe/stripe-js'), require('react-redux'), require('redux-persist/integration/react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@reduxjs/toolkit', 'uuid', 'redux-persist', '@stripe/stripe-js', 'react-redux', 'redux-persist/integration/react'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.UseShoppingCart = {}, global.React, global.RTK, global.uuid, global.ReduxPersist, global["@stripe/stripe-js"], global["react-redux"], global["redux-persist/integration/react"]));
})(this, (function (exports, React, toolkit, uuid, reduxPersist, stripeJs, reactRedux, react) { 'use strict';
  ...
  function getCheckoutData(cart) {
    ...
    if (_optionalChain$1([cart, 'access', _ => _.allowedCountries, 'optionalAccess', _2 => _2.length])) {
  ...
  const _jsxFileName = "/Users/nickdejesus/Code/hooks/use-shopping-cart/use-shopping-cart/react/index.js"; function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }const CartContext = React__namespace.createContext(initialState);
  ...
  function CartProvider({ loading = null, children, ...props }) {
    ...
    if (_optionalChain([props, 'optionalAccess', _ => _.shouldPersist]) || props.shouldPersist === undefined) {
      return (
        React__namespace.createElement(reactRedux.Provider, { context: CartContext, store: store, __self: this, __source: {fileName: _jsxFileName, lineNumber: 24}}
      ...
      return (
        React__namespace.createElement(reactRedux.Provider, { context: CartContext, store: store, __self: this, __source: {fileName: _jsxFileName, lineNumber: 36}}
          , children
        )
      )
    }
  ...
  function DebugCart(props) {
    ...
    const cartPropertyRows = Object.entries(cart)
      ...
      .map(([key, value]) => (
        React__namespace.createElement('tr', { key: key, __self: this, __source: {fileName: _jsxFileName, lineNumber: 64}}
          , React__namespace.createElement('td', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 65}}, key)
          , React__namespace.createElement('td', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 66}}
            , typeof value === 'object' ? (
              React__namespace.createElement('button', { onClick: () => console.log(value), __self: this, __source: {fileName: _jsxFileName, lineNumber: 68}}, "Log value" )
            ) : (
    ...
    return (
      React__namespace.createElement('div', {
        ...
        , React__namespace.createElement('table', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 91}}
          , React__namespace.createElement('thead', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 92}}
            , React__namespace.createElement('tr', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 93}}
              , React__namespace.createElement('th', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 94}}, "Key")
              , React__namespace.createElement('th', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 95}}, "Value")
            )
          )
          , React__namespace.createElement('tbody', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 98}}, cartPropertyRows)
        )
      )
    )
  }
